...
class TestOvsNeutronAgent(base.BaseTestCase):
    ...
    def test_scan_ports_with_port_changes_and_updated_ports(self):
        self._test_scan_ports_with_updated_ports(set([4]))

    def test_scan_ports_with_port_changes_and_unknown_updated_ports(self):
    ...
    def test_scan_ports_with_update_on_removed_port(self):
        vif_port_set = set([1, 3])
        registered_ports = set([1, 2])
    ...
    def test_scan_ports_with_updated_port_only(self):
